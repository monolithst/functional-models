import {IModelFunction, IModel, IModelInstanceFunction, IModelInstance, IModelInstanceFunctionTyped} from "../../src/interfaces"
...
describe('/src/models.ts', () => {
  describe('#Model()', () => {
    it('should pass a functional instance to the instanceFunctions by the time the function is called by a client', () => {
      const model = Model<{
        name: string,
        func1: IModelInstanceFunction,
        func2: IModelInstanceFunction,
      }>(
        'ModelName',
        {},
        {
          instanceFunctions: {
            func1: (instance: IModelInstance<any>) => {
              // @ts-ignore
